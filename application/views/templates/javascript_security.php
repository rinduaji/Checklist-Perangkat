  ...
  if ('<?= $this->uri->segment(2) ?>' == 'pc') {
    $(document).ready(function() {
      ...
      function tampil_data_pc(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistSecurity/pc_list/' + bulan + '/' + tahun + '/' + shift,
           method: 'GET',
          async: false,
          dataType: 'JSON',
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistSecurity/pc_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/edit/pc') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistSecurity/hapus/pc/') ?>" + this.value;
        }
      });

      $('#show_data').on('click', '#btnApproveTL', function() {
        if (confirm("Yakin akan Approve data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistSecurity/editApproveTL/pc/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/tambah/ac') ?>");
      ...
      function tampil_data_ac(bulan, tahun, idRuangan) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistSecurity/ac_list/' + bulan + '/' + tahun + '/' + idRuangan,
           method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistSecurity/ac_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/edit/ac') ?>");
        $('#myModal').modal('show');
      });

      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistSecurity/hapus/ac/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/tambah/ups') ?>");
      ...
      function tampil_data_ups(bulan, tahun) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistSecurity/ups_list/' + bulan + '/' + tahun,
           method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistSecurity/ups_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/edit/ups') ?>");
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        ...
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistSecurity/hapus/ups/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      let table = $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            ...
            $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/tambah/cctv') ?>");
      ...
      function tampil_data_cctv(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistSecurity/cctv_list/' + bulan + '/' + tahun + '/' + shift,
           method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistSecurity/hapus/cctv/') ?>" + this.value;
        }
      });
      ...
      $('#btnEditCheck').click(function() {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistSecurity/edit/cctv') ?>");
      ...
      $('#input_tanggalEdit').on('change input', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistSecurity/cctv_list/nope/nope/nope/' + ($('#input_id_check_cctv').val()),
          dataType: 'json',
          success: function(data) {
