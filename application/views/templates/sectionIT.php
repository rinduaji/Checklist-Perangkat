  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?= ($this->uri->segment(1)=='home') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('home/homeIT') ?>">Home</a>
      </li>
      <li class="nav-item <?= ($this->uri->segment(2)=='pc') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistIT/pc') ?>">PC</a>
      </li>
   <!--    <li class="nav-item <?= ($this->uri->segment(2)=='ac') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistIT/ac') ?>">AC</a>
      </li> -->
      <!-- <li class="nav-item <?= ($this->uri->segment(2)=='cctv') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistIT/cctv') ?>">CCTV</a>
      </li>
      <li class="nav-item <?= ($this->uri->segment(2)=='ups') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistIT/ups') ?>">UPS</a>
      </li> -->
    </ul>
