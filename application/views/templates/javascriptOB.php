  ...
  if ('<?= $this->uri->segment(2) ?>' == 'pc') {
    $(document).ready(function() {
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              ...
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/pc') ?>");
      ...
      function tampil_data_pc(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/pc_list/' + bulan + '/' + tahun + '/' + shift,
          method: 'GET',
          async: false,
          dataType: 'JSON',
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/pc_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/pc') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/pc/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/ac') ?>");
      ...
      function tampil_data_ac(bulan, tahun, idRuangan) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/ac_list/' + bulan + '/' + tahun + '/' + idRuangan,
          async: false,
          dataType: 'json',
          success: function(data) {
            var html = '';
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/ac_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/ac') ?>");
        $('#myModal').modal('show');
      });

      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/ac/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/ups') ?>");
      ...
      function tampil_data_ups(bulan, tahun) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/ups_list/' + bulan + '/' + tahun,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/ups_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/ups') ?>");
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        ...
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/ups/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      function tampil_data_cctv(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/cctv_list/' + bulan + '/' + tahun + '/' + shift,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/cctv/') ?>" + this.value;
        }
      });
      ...
      $('#btnEditCheck').click(function() {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/cctv') ?>");
      ...
      $('#input_tanggalEdit').on('change input', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/cctv_list/nope/nope/nope/' + ($('#input_id_check_cctv').val()),
          dataType: 'json',
          success: function(data) {
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/apar') ?>");
      ...
      function tampil_data_apar(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/apar_list/' + bulan + '/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/apar_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/apar') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/apar/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/lift') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
              $('#input_id_lift').val('');
              $('#input_jenis').val('');
              $('#myModal').modal('show');
      ...
      function tampil_data_lift(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/lift_list/' + bulan + '/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/lift_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/lift') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/lift/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/genset') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
              $('#input_id_genset').val('');
              $('#input_jenis').val('');
              $('#myModal').modal('show');
      ...
      function tampil_data_genset(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/genset_list/' + bulan + '/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/genset_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/genset') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/genset/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/hydrant') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
      ...
      function tampil_data_hydrant(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/hydrant_list/' + bulan + '/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/hydrant_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/hydrant') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/hydrant/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/fap') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
              $('#input_id_fap').val('');
              $('#input_jenis').val('');
              $('#myModal').modal('show');
      ...
      function tampil_data_fap(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/fap_list/' + bulan + '/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/fap_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/fap') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/fap/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/penilaian_vendor') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
      ...
      function tampil_data_penilaian_vendor(tahun) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/penilaian_vendor_list/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/penilaian_vendor_list/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/penilaian_vendor') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/penilaian_vendor/') ?>" + this.value;
        }
      });
    });
  }
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          // },
          {
            ...
            action: function(e, dt, node, config) {
              $('.modal-title').text('Tambah Data');
              $('#myForm').attr('action', "<?= site_url('ChecklistOB/tambah/me_vendor') ?>");
              $('#input_bulan_tahun').val('<?= date('d-m-Y') ?>');
      ...
      function tampil_data_me_vendor(tahun) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistOB/me_vendor_list/' + tahun ,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistOB/me_vendor_list/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
            $('#input_bulan_tahun').val(moment(data[0].bulan_tahun).format('YYYY-MM'));
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistOB/edit/me_vendor') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistOB/hapus/me_vendor/') ?>" + this.value;
        }
      });
    });
  }
