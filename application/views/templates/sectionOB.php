  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?= ($this->uri->segment(1)=='home') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('home/homeOB') ?>">Home</a>
      </li>
      <li class="nav-item <?= ($this->uri->segment(2)=='kebersihan') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistOB/kebersihan') ?>">Kebersihan</a>
      </li>
   <!--    <li class="nav-item <?= ($this->uri->segment(2)=='ac') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistOB/ac') ?>">AC</a>
      </li> -->
      <!-- <li class="nav-item <?= ($this->uri->segment(2)=='cctv') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistOB/cctv') ?>">CCTV</a>
      </li>
      <li class="nav-item <?= ($this->uri->segment(2)=='ups') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= site_url('ChecklistOB/ups') ?>">UPS</a>
      </li> -->
    </ul>
