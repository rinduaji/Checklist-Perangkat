  ...
  if ('<?= $this->uri->segment(2) ?>' == 'pc') {
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [
          ...
          //     $('#myForm').attr('action', "<?= site_url('ChecklistIT/tambah/pc') ?>");
      ...
      function tampil_data_pc(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistIT/pc_list/' + bulan + '/' + tahun + '/' + shift,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
              ...
              html += '<tr>' +
                ...
                '<td>' + data[i].status + '</td>' +
                '<td><button id="btnApproveIT" class="btn btn-warning" value="' + data[i].id_checklist_pc + '">Approve IT</button> <a href="<?= base_url() ?>uploads/PC/' + data[i].gambar + '" class = "btn btn-primary"> Lihat Gambar </a></td > ' +
                '</tr>';
            }
            $('#show_data').html(html);
          }
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistIT/pc_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistIT/edit/pc') ?>");
        // alert("ID = "+this.value);
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistIT/hapus/pc/') ?>" + this.value;
        }
      });

      $('#show_data').on('click', '#btnApproveIT', function() {
        if (confirm("Yakin akan Approve data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistIT/editClosed/pc/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistIT/tambah/ac') ?>");
      ...
      function tampil_data_ac(bulan, tahun, idRuangan) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistIT/ac_list/' + bulan + '/' + tahun + '/' + idRuangan,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistIT/ac_list/nope/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistIT/edit/ac') ?>");
        $('#myModal').modal('show');
      });

      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistIT/hapus/ac/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            $('.modal-title').text('Tambah Data');
            $('#myForm').attr('action', "<?= site_url('ChecklistIT/tambah/ups') ?>");
      ...
      function tampil_data_ups(bulan, tahun) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistIT/ups_list/' + bulan + '/' + tahun,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnEdit', function() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistIT/ups_list/nope/nope/' + this.value,
          dataType: 'json',
          success: function(data) {
        ...
        $('.modal-title').text('Edit Data');
        $('#myForm').attr('action', "<?= site_url('ChecklistIT/edit/ups') ?>");
        $('#myModal').modal('show');
      });
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        ...
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistIT/hapus/ups/') ?>" + this.value;
        }
      });
    });
    ...
    $(document).ready(function() {
      ...
      let table = $('#myTable').DataTable({
        ...
        buttons: [{
          ...
          action: function(e, dt, node, config) {
            ...
            $('#myForm').attr('action', "<?= site_url('ChecklistIT/tambah/cctv') ?>");
      ...
      function tampil_data_cctv(bulan, tahun, shift) {
        $.ajax({
          type: 'ajax',
          url: '<?php echo site_url() ?>/ChecklistIT/cctv_list/' + bulan + '/' + tahun + '/' + shift,
          method: 'GET',
          async: false,
          dataType: 'JSON',
          success: function(data) {
      ...
      $('#show_data').on('click', '#btnHapus', function() {
        if (confirm("Yakin akan menghapus data yang dipilih?")) {
          window.location.href = "<?= site_url('ChecklistIT/hapus/cctv/') ?>" + this.value;
        }
      });
      ...
      $('#btnEditCheck').click(function() {
        ...
        $('#myForm').attr('action', "<?= site_url('ChecklistIT/edit/cctv') ?>");
      ...
      $('#input_tanggalEdit').on('change input', function() {
        ...
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url() ?>/ChecklistIT/cctv_list/nope/nope/nope/' + ($('#input_id_check_cctv').val()),
          dataType: 'json',
          success: function(data) {
