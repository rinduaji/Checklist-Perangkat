...
<head>
  ...
  <title>Maintenance Vendor | Pengecekan</title>
...
<body>
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <input type="hidden" name="bagian" value="me_vendor">
      <h1>CHECKLIST Maintenance Vendor</h1>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input id="input_id_me_vendor" type="hidden" name="id_me_vendor" value="">
