  ...
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <div class="text-center">
        <p></p>
        Ruangan :
        <select name="id_ruangan" id="inputRuangan" class="">
          <?php foreach ($ruangan as $b): ?>
            <option value="<?= $b->id_ruangan ?>"><?= $b->nama_ruangan ?> lantai <?= $b->lantai ?></option>
          <?php endforeach ?>
        </select>
      </div>
      <?= form_close(); ?>
        ...
        <div class="modal-body">
          ...
          <table class="table table-hover">
            <tr class="form-group">
              ...
              <td>
                <select name="id_ruangan" id="input_ruangan" class="form-control" required>
            ...
            <tr class="form-group">
              <td>
                Status AC
                <select name="sts_ac_pagi" id="input_sts_ac_pagi" class="form-control" required>
                  <option value="">---Pilih Status AC---</option>
                  <option value="ok">OK</option>
                  <option value="not ok">Not OK</option>
                </select>
                Temperature
                <input id="input_temp_pagi" type="number" class="form-control" placeholder="Temperature" name="temp_pagi" required>
                PIC
                <select name="pic_pagi" id="input_pic_pagi" class="form-control" required>
