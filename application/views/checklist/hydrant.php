...
<head>
  ...
  <title>HYDRANT | Pengecekan</title>
...
<body>
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <input type="hidden" name="bagian" value="hydrant">
      <h1>CHECKLIST HYDRANT</h1>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input id="input_id_hydrant" type="hidden" name="id_hydrant" value="">
