  ...
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <table id="myTable" class="table table-bordered table-hover" width="100%">
        ...
        <tbody id="show_data">
          <!-- <?php foreach ($pc as $val): ?>
            <tr>
              <td class="text-center"><?= $val->pc_id ?></td>
              <td><?= date('d-m-Y', strtotime($val->tanggal)) ?></td>
              <td><?= $val->nama_petugas ?></td>
              <td class="text-center"><?= ($val->M1=='cek') ? '&#x2713;' : '-'; ?></td>
              <td class="text-center"><?= ($val->M2=='cek') ? '&#x2713;' : '-'; ?></td>
              <td class="text-center"><?= ($val->CPU=='cek') ? '&#x2713;' : '-'; ?></td>
              <td><?= $val->TL ?></td>
              <td><?= $val->IT ?></td>
            ...
            <table class="table table-hover">
              ...
              <tr class="form-group">
                ...
                <td>
                  ...
                  <input id="input_TL" type="text" name="TL" id="inputTL" class="form-control" placeholder="Nama TL">
                  <label for="inputIT">Nama IT</label>
                  <input id="input_IT" type="text" name="IT" id="inputIT" class="form-control" placeholder="Nama IT">
                </td>
              </tr>
              <tr class="form-group">
                <td>
