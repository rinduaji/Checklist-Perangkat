...
<head>
  ...
  <title>Penilaian Vendor | Pengecekan</title>
...
<body>
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <input type="hidden" name="bagian" value="penilaian_vendor">
      <h1>CHECKLIST Penilaian Vendor</h1>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input id="input_id_penilaian_vendor" type="hidden" name="id_penilaian_vendor" value="">
