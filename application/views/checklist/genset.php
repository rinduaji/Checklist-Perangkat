...
<body>
  <div class="container-fluid home">
    ...
    <div class="isi">
      ...
      <input type="hidden" name="bagian" value="genset">
      <h1>CHECKLIST GENSET</h1>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input id="input_id_genset" type="hidden" name="id_genset" value="">
