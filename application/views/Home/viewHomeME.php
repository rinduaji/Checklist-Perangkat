...
<body>
  <div class="container-fluid home">
    <?php $this->load->view('templates/sectionME'); ?>
    <div class="konten">
      <div class="pc">
        <i class="fas fa-desktop fa-5x"></i>
        <h2>PC</h2>
        <a href="<?= site_url('ChecklistME/pc') ?>" class="btn btn-primary">Lihat</a>
      </div>
     <!--  <div class="ac">
      ...
      <div class="cctv">
        ...
        <h2>cctv</h2>
        <a href="<?= site_url('ChecklistME/cctv') ?>" class="btn btn-primary">Lihat</a>
      </div>
      <div class="ups">
        <i class="fas fa-hdd fa-5x"></i>
        <h2>UPS</h2>
        <a href="<?= site_url('ChecklistME/ups') ?>" class="btn btn-primary">Lihat</a>
      </div>
      <div class="pc">
        <i class="fas fa-hdd fa-5x"></i>
        <h2>APAR</h2>
  ...
  <?php $this->load->view('templates/javascript_ME'); ?>
</body>
</html>