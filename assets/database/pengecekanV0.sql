...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2019 at 10:47 AM
...
INSERT INTO `cctv` (`id_cctv`, `id_ruangan`, `tanggal`, `shift`, `keterangan`) VALUES
(1, 1, '2019-01-01', 'pagi', ''),
(2, 2, '2019-01-01', 'pagi', ''),
(3, 3, '2019-01-01', 'pagi', ''),
(4, 4, '2019-01-01', 'pagi', ''),
...
(8, 2, '2019-01-01', 'sore', ''),
(9, 3, '2019-01-01', 'sore', ''),
(10, 4, '2019-01-01', 'sore', ''),
(11, 5, '2019-01-01', 'sore', ''),
(12, 6, '2019-01-01', 'sore', ''),
(13, 1, '2019-01-01', 'malam', ''),
(14, 2, '2019-01-01', 'malam', ''),
(15, 3, '2019-01-01', 'malam', ''),
(16, 4, '2019-01-01', 'malam', ''),
(17, 5, '2019-01-01', 'malam', ''),
(18, 6, '2019-01-01', 'malam', '');
...
--
-- Table structure for table `checklist_cctv`
--

CREATE TABLE `checklist_cctv` (
  `id_checklist_cctv` int(11) NOT NULL,
  `id_cctv` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `kondisi` enum('baik','tidak') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `checklist_cctv`
--

INSERT INTO `checklist_cctv` (`id_checklist_cctv`, `id_cctv`, `tanggal`, `kondisi`) VALUES
(1, 1, '2019-01-17', 'baik'),
(2, 1, '2019-01-18', 'baik'),
(3, 1, '2019-01-19', 'tidak'),
(4, 1, '2019-01-20', 'baik');
...
--
-- Table structure for table `paraf_cctv`
--

CREATE TABLE `paraf_cctv` (
  `id_paraf_cctv` int(11) NOT NULL,
  `id_cctv` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `paraf` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `checklist_cctv`
--
ALTER TABLE `checklist_cctv`
  ADD PRIMARY KEY (`id_checklist_cctv`),
  ADD KEY `id_cctv` (`id_cctv`);
...
--
-- Indexes for table `paraf_cctv`
--
ALTER TABLE `paraf_cctv`
  ADD PRIMARY KEY (`id_paraf_cctv`);
...
--
ALTER TABLE `cctv`
  MODIFY `id_cctv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
-- AUTO_INCREMENT for table `checklist_cctv`
--
ALTER TABLE `checklist_cctv`
  MODIFY `id_checklist_cctv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `paraf_cctv`
--
ALTER TABLE `paraf_cctv`
  MODIFY `id_paraf_cctv` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cctv`
  ADD CONSTRAINT `cctv_ibfk_1` FOREIGN KEY (`id_ruangan`) REFERENCES `ruangan` (`id_ruangan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `checklist_cctv`
--
ALTER TABLE `checklist_cctv`
  ADD CONSTRAINT `checklist_cctv_ibfk_1` FOREIGN KEY (`id_cctv`) REFERENCES `cctv` (`id_cctv`) ON DELETE CASCADE ON UPDATE CASCADE;
